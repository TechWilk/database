...
trait MySqlQueryHelpersTrait
{
    use ParseDataArray;
    use MySqlSecureTableField;

    abstract public function query(string $sql, array $params = []): DatabaseResultInterface;

    abstract public function runQuery(Query $query): DatabaseResultInterface;
